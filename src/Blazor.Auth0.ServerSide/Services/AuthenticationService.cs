...
namespace Blazor.Auth0.ServerSide.Authentication
{
    public class AuthenticationService
    {
        ...
        private readonly IJSRuntime jsRuntimeService;
        ...
        private Timer injectJavascriptTimer;

        private IComponentContext componentContextService;

        public AuthenticationService(IComponentContext componentContext, HttpClient httpClient, IJSRuntime jsRuntime, IUriHelper uriHelper, ClientSettings settings)
        {
            ...
            injectJavascriptTimer = new Timer(500);
            injectJavascriptTimer.Elapsed += (Object source, ElapsedEventArgs e) => InjectJavascript();
        ...
        private async Task<bool> ValidateNonce(string idToken) {
...
(function (window, document) {
    ...
    window.drawAuth0Iframe = (instance, src) => {
        ...
        window.addEventListener('message', messageListener);
                ...
                var result = Task.Run(async () => await jsRuntimeService.InvokeAsync<object>("eval", magicString)).Result;
